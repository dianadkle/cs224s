...
min_seq_length = 50  ## can be changed to 50 if 50 is used in mfcc_extraction.py
dirData = "data-50"  ## 'data-50' the directory where mfcc_features, delta_features, fbank_features reside
...
if learning_rate_init_tuning :
    ...
    for hidden_layer_sizes in [(100), (100, 100)]:  #todo please add more
